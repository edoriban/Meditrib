...
def get_product(db: Session, product_id: int, tenant_id: int = None) -> Optional[models.Product]:
...
def get_product_by_barcode(db: Session, barcode: str, tenant_id: int = None) -> Optional[models.Product]:
...
def update_product(db: Session, product_id: int, product: schemas.ProductUpdate, tenant_id: int = None) -> Optional[models.Product]:
...
def delete_product(db: Session, product_id: int, tenant_id: int = None) -> Optional[models.Product]:
    """Delete a product"""
    db_product = get_product(db, product_id, tenant_id)
    if not db_product:
        return None
